...
export function makeBrand(baseUrl) {
  return {
    ...
    site: process.env.SITE_URL || baseUrl || "https://stb-singapore.com",
...
export async function handlePostAssign(voucherCode, body) {
  ...
  const message = updated ? "✓ Saved. Guest reminder will fire 12h before pickup with these details." : "";
  return {
